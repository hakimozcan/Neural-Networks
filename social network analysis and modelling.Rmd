...
survey_thresholds <- read.csv("Question15_OnceABeefThreshold.csv")
survey_thresholds
```
...
```{r}
# Read in the data
facebook_page_network_edges <- read.csv("musae_facebook_edges.csv",
                                        header=FALSE)
facebook_page_network_att <- read.csv("musae_facebook_target.csv",
                                        header=FALSE)
```
